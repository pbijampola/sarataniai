...
const Business = () =>  (
  <section id="features" className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
    ...
    <h2 className={`${styles.heading2} text-gradient`}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>At <span className='text-gradient font-poppins font-bold'>Saratani</span><span className='text-white'>Ai</span>,
